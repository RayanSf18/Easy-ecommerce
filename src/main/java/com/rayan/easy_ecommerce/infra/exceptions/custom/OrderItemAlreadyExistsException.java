...
public class OrderItemAlreadyExistsException extends EasyEcommerceException {

          private final String detail;

          public OrderItemAlreadyExistsException(String detail) {
                    this.detail = detail;
          }
          ...
          public ProblemDetail toProblemDetail() {
                    ...
                    problemDetail.setTitle("OrderItem already exists");
